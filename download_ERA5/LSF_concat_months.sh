...
# -- our name ---
#BSUB -J concatenate_months_1954_1956
# -- choose queue --
#BSUB -q hpc
...
bash /zhome/98/d/202490/Documents/Thesis/ClimateDiffuse/download_ERA5/ERA5_concat_months.sh > /zhome/98/d/202490/Documents/Thesis/ClimateDiffuse/.lsf_jobs/joboutput_$LSB_JOBID.out 2>&1
