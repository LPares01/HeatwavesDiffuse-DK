...
bash /zhome/98/d/202490/Documents/Thesis/ClimateDiffuse_sync/download_ERA5/isilon_preprocess_project > /zhome/98/d/202490/Documents/Thesis/ClimateDiffuse_sync/.lsf_jobs/joboutput_$LSB_JOBID.out 2>&1
